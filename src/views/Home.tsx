        ...
        <section className="max-w-[1200px] mx-auto px-4 flex flex-col-reverse lg:grid lg:grid-cols-[1fr_auto] place-items-center gap-9 lg:h-screen pb-24 lg:pb-52">
            <div className="lg:text-end">
                ...
                <div className="flex justify-end">
                    <a href="#Contact" className="inline-flex gap-2 bg-primary text-background p-3 rounded-xl mt-3 lg:mt-1 mr-2 hover:scale-105 transition-all">{t('translation.contact_button')}
