    ...
    return (
        ...
        <section className="max-w-[1200px] mx-auto text-center px-2">
            ...
            <div className="flex gap-2 items-center justify-center">
                ...
                <a href="" className="bg-primary text-background p-3 rounded-md hover:scale-105 transition-all"><img src={send} alt="" width="20px"/></a>
                <button onClick={copyToClipboard} className="bg-primary text-background p-3 rounded-md hover:scale-105 transition-all"><img src={copy} alt="" width="20px"/></button>
            </div>
