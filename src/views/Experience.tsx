        ...
        <section className="max-w-[1200px] mx-auto mt-10 mb-24 px-2 sm:px-10" id="Experience">
            ...
            <div className="mx-8 lg:mx-10">
                ...
                <Timeline.Item className="transition-colors duration-300">
                        ...
                        <Timeline.Content>
                            <Timeline.Time className="text-tertiary">October 2024</Timeline.Time>
                            ...
                            <Timeline.Body className="text-secondary dark:text-secondary_dark transition-colors duration-300">
                                We'll see. &#128561;
                            </Timeline.Body>
                        </Timeline.Content>
                    </Timeline.Item>
                    ...
                    <Timeline.Item className="transition-colors duration-300">
                        <Timeline.Point className="point"/> 
                        <Timeline.Content>
                            <Timeline.Time className="text-tertiary">August 2023</Timeline.Time>
                            <Timeline.Title className="text-xl text-primary transition-colors duration-300">Full Stack Web Developer. Henry Bootcamp.</Timeline.Title>
                            <Timeline.Body className="text-secondary dark:text-secondary_dark transition-colors duration-300">
                    ...
                    <Timeline.Item>
                        <Timeline.Point className="point"/>
                        <Timeline.Content>
                            <Timeline.Time className="text-tertiary">July 2022</Timeline.Time>
                            <Timeline.Title className="text-xl text-primary transition-colors duration-300">Electromechanical Maintenance. Mexico Aviation School.</Timeline.Title>
                            <Timeline.Body className="text-secondary dark:text-secondary_dark transition-colors duration-300">
                    ...
                    <Timeline.Item>
                        <Timeline.Point className="point"/>
                        <Timeline.Content>
                            <Timeline.Time className="text-tertiary">May 2021</Timeline.Time>
                            <Timeline.Title className="text-xl text-primary transition-colors duration-300">Mechanical Maintenance. Minigrip Mexico.</Timeline.Title>
                            <Timeline.Body className="text-secondary dark:text-secondary_dark transition-colors duration-300">
